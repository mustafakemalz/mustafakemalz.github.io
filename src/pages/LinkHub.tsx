...
export const LinkHub: React.FC = () => {
  ...
  const links: LinkItem[] = [
    ...
    },
    {
      id: 'instagram',
      title: 'Instagram',
      url: 'https://instagram.com/@muskscullz',
      brandColor: '#f472b6',
    ...
    },
    {
      id: 'spotify',
      title: 'Spotify',
      url: 'https://open.spotify.com/user/0wu2ixnxr61i99ci84hgtlolr',
      brandColor: '#1DB954',
    ...
    },
    {
      id: 'mail',
      title: 'Mail',
      url: 'mailto:mustafakemalgocer@gmail.com',
      brandColor: '#38bdf8',
